...
##########-------------------------------------------------
##########
# Model 11: Y = F1 + F2 + F3 + F1*F2 + F1*F3 + F2*F3
##########
##########-------------------------------------------------
...
# 1-1. Train set:
	...
	X_t <- cbind(x1_t,x2_t,x3_t,inters_t1,inters_t2,inters_t3)

	nvar_t <- matrix(c(ncol(x1_t),ncol(x2_t),ncol(x3_t),ncol(inters_t1),ncol(inters_t2),ncol(inters_t3)), ncol=6)
...
# 1-2. Test set:
	...
	X_v <- cbind(x1_v,x2_v,x3_v,inters_v1,inters_v2,inters_v3)

	nvar_v <- matrix(c(ncol(x1_v),ncol(x2_v),ncol(x3_v),ncol(inters_v1),ncol(inters_v2),ncol(inters_v3)), ncol=6)
